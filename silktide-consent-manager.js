...
class SilktideCookieBanner {
	...
	getBannerContent() {
		...
		// Ahold Delhaize logo link
		const aholdLogo = `
  			<a class="silktide-logo" href="https://www.aholddelhaize.com" target="_blank" aria-label="Ahold Delhaize">
    		<img src="https://www.aholddelhaize.com/media/efmdlwt4/ad_logo_lion_mark_apple.png" 
	...
	getModalContent() {
		...
		const closeModalButton = `<button class="modal-close" aria-label="Terug naar banner">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15.5 3.5L6.5 10L15.5 16.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </button>`;
